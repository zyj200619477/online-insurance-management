...
<title>policyholder sign up</title>
...
<script>
    function check(){
    	...
    	var hpwd= document.loginForm.hpwd.value;
...
<body>
<form id="loginForm" action="holderRegisterBack.jsp" name="loginForm" onsubmit="return check()">
		<div class="hname">
		...
		<div class="hbank">
			<input type="text" placeholder="Credit Card Bank" name="hbank" />
		</div>
		<div class="hbirth">
