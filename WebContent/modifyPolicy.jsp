...
<script>
    function check(){
    	var pid=document.policyForm.pid.value;
        ...
        if(pid==0){
            alert('Please Enter policy ID that going to modify');
            document.policyForm.pid.focus();
            return false;       
        }
         if(pname==0){
...
<body>
<form id="loginForm" action="modifyPolicyBack.jsp" name="policyForm" onsubmit="return check()">
		<div class="pid">
			<input type="text" placeholder="Policy ID" name="pid" />
		</div>
		<div class="pname">
